...
public class ModificarDatos extends javax.swing.JFrame {
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(txtRaza, javax.swing.GroupLayout.DEFAULT_SIZE, 390, Short.MAX_VALUE)))
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addGap(18, 18, 18)
                                .addComponent(txtColor, javax.swing.GroupLayout.PREFERRED_SIZE, 390, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(jPanel3Layout.createSequentialGroup()
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        String celularDuenio = txtCelularDueño.getText();
        
        String alergico = (String)cmbAlergico.getSelectedItem();
        String atencionEspecial = (String)cmbAtencionEspecial.getSelectedItem();
        
        
        controladora.modificarMascota(mascota, nombre_mascota,raza,color,observaciones,nombreDuenio,celularDuenio,alergico,atencionEspecial);
        
        mostrarMensaje("La edicion se realizo con exito","Info","Edicion exitosa");
    ...
    private void cargarDatos(int num_cliente) {
        ...
        txtCelularDueño.setText(mascota.getUnDuenio().getCelDueño());
